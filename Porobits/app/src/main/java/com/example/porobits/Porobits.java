...
//		Amarino.sendDataToArduino(this, DEVICE_ADDRESS, convertNameToFlag(currentSquare), VIBRATE);
	...
	public void doneRecording() {
		//SEND INFLATE CODE
//		Amarino.sendDataToArduino(this, DEVICE_ADDRESS, convertNameToFlag(currentSquare), INFLATE);
...
//		Amarino.sendDataToArduino(this, DEVICE_ADDRESS, convertNameToFlag(currentSquare), DEFLATE);
